import {
  DeleteOutlined, DownloadOutlined, EditOutlined, MoreHorizOutlined, VisibilityOutlined
} from '@mui/icons-material';
import {
  Checkbox, Dialog, DialogContent, DialogTitle, LinearProgress,
...
const EditShift = ({ ClosedShift, setOpenEditDialog }) => {
  ...
  return <SaleShiftForm SalesShift={shiftData} setOpenDialog={setOpenEditDialog} />;
};
      ...
      <DialogTitle>
        <Stack direction="row" justifyContent="center" alignItems="center" spacing={1}>
          ...
          <Checkbox
            ...
            onChange={(e) => setIncludeFuelVouchers(e.target.checked)}
          />
        </Stack>
      </DialogTitle>
...
const SalesShiftsItemAction = ({ ClosedShift }) => {
  ...
  return (
    <>
      ...
      >
        {openEditDialog && (
          <EditShift ClosedShift={ClosedShift} setOpenEditDialog={setOpenEditDialog} />
        )}

        {openDocumentDialog && (
          <DocumentDialog ClosedShift={ClosedShift} organization={organization} />
        )}
      </Dialog>
